...
def watershed1(image, viz=False):
    ...
    mb = cv2.morphologyEx(binary, cv2.MORPH_OPEN, kernel, iterations=2)  # iterations???��?�ާ@
    sure_bg = cv2.dilate(mb, kernel, iterations=3)  # 3����?,�i�H?����j�������O�I����?��
    if viz:
    ...
    surface_fg = np.uint8(sure_fg)  # �O����m��?�@�P�~��?��?��A?�b�O�I����??�㫬��?�A�e��?�B?����?�A�ҥH?��??
    if viz:
        cv2.imshow("surface_fg", surface_fg)
        cv2.waitKey()
    unknown = cv2.subtract(sure_bg, surface_fg)
    # ?��maskers,�bmarkers���t�����l?��
